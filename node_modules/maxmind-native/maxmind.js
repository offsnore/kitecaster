...
var GeoIP = function(filename) {
	this.GEOIP_COUNTRY_BEGIN = 16776960;

	this.GEOIP_COUNTRY_CODES = [ "", "AP", "EU", "AD", "AE", "AF", "AG", "AI",
			...
			"FR", "FX", "GA", "GB", "GD", "GE", "GF", "GH", "GI", "GL", "GM",
			"GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW", "GY", "HK", "HM",
			"HN", "HR", "HT", "HU", "ID", "IE", "IL", "IN", "IO", "IQ", "IR",
			...
			"TC", "TD", "TF", "TG", "TH", "TJ", "TK", "TM", "TN", "TO", "TL",
			"TR", "TT", "TV", "TW", "TZ", "UA", "UG", "UM", "US", "UY", "UZ",
			"VA", "VC", "VE", "VG", "VI", "VN", "VU", "WF", "WS", "YE", "YT",
			"RS", "ZA", "ZM", "ME", "ZW", "A1", "A2", "O1", "AX", "GG", "IM",
			"JE", "BL", "MF" ];

	this.GEOIP_COUNTRY_CODES3 = [ "", "AP", "EU", "AND", "ARE", "AFG", "ATG",
			"AIA", "ALB", "ARM", "ANT", "AGO", "AQ", "ARG", "ASM", "AUT",
			"AUS", "ABW", "AZE", "BIH", "BRB", "BGD", "BEL", "BFA", "BGR",
			"BHR", "BDI", "BEN", "BMU", "BRN", "BOL", "BRA", "BHS", "BTN",
			"BV", "BWA", "BLR", "BLZ", "CAN", "CC", "COD", "CAF", "COG", "CHE",
			"CIV", "COK", "CHL", "CMR", "CHN", "COL", "CRI", "CUB", "CPV",
			"CX", "CYP", "CZE", "DEU", "DJI", "DNK", "DMA", "DOM", "DZA",
			"ECU", "EST", "EGY", "ESH", "ERI", "ESP", "ETH", "FIN", "FJI",
			"FLK", "FSM", "FRO", "FRA", "FX", "GAB", "GBR", "GRD", "GEO",
			"GUF", "GHA", "GIB", "GRL", "GMB", "GIN", "GLP", "GNQ", "GRC",
			"GS", "GTM", "GUM", "GNB", "GUY", "HKG", "HM", "HND", "HRV", "HTI",
			...
			"ZWE", "A1", "A2", "O1", "ALA", "GGY", "IMN", "JEY", "BLM", "MAF" ];

	this.GEOIP_COUNTRY_NAMES = [ "", "Asia/Pacific Region", "Europe",
...
GeoIP.prototype.getCountry = function(ipaddress, type) {
	...
	if (c < 0) return ""; // should never get here

	if (type == 'code')
		return this.GEOIP_COUNTRY_CODES[c];
	else if (type == 'code3')
		return this.GEOIP_COUNTRY_CODES3[c];
	else if (type == 'id')
		return c;
	else
...
GeoIP.prototype._seekCountry = function(ipaddress) {
	...
	for ( var depth = 31; depth >= 0; --depth) {
		var buf_offset = 2 * this.record_length * offset;

		var x = [ 0, 0 ];
		for ( var i = 0; i < 2; ++i) {
			for ( var j = 0; j < this.record_length; ++j) {
				x[i] += this.buffer.charCodeAt(buf_offset + this.record_length * i + j) << (j * 8);
			}
		}
